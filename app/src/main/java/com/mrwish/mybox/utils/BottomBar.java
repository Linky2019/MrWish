...
public class BottomBar extends View {
    ...
    private int titleColorBefore = Color.parseColor("#333333");
    private int titleColorAfter = Color.parseColor("#999999");
...
//             //这个是文字在上图片在下
//            titleBaseLine = (parentItemHeight  - textIconMargin + iconHeight-4)/2;//这里都是乱写的 调整到位置对就行
//            int iconTop = parentItemHeight+iconHeight-titleBaseLine;
        ...
        if (itemCount != 0) {
            ...
            for (int i = 0; i < itemCount; i ++) {
                ...
                if (i == currentCheckedIndex) {
                    ...
                    paint.setTypeface(Typeface.DEFAULT);//常规
                }
