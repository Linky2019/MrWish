...
public class AbStrUtil {
    ...
    public static String getSmallImage(String imagePath) {
        ...
        if (imagePath.contains("_100x100")) {
            return imagePath;
        }
        ...
        if (!AbStrUtil.isEmpty(imagePath)) {
            ...
            return builder.toString().replace("._100x100.", "_100x100.");
        }
        return "";
    }
    ...
    public static String getStringDecimalFormat(String object) {
        DecimalFormat df = new DecimalFormat("00000");
        String result = df.format(Integer.parseInt(object.toString()));
        return result;
    }
