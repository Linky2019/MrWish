...
import com.baselibrary.widget.pulltorefresh.internal.IndicatorLayout;
...
public abstract class PullToRefreshAdapterViewBase<T extends AbsListView> extends PullToRefreshBase<T> implements
	...
	private OnPreRefreshingAnimListener mOnPreRefreshingAnimListener;//底部动画开始前的回调
	...
	public final void onScrollStateChanged(final AbsListView view, final int state) {
		...
		if (state == OnScrollListener.SCROLL_STATE_IDLE && null != mOnLastItemVisibleListener && mLastItemVisible) {
			...
			if( mOnPreRefreshingAnimListener != null ){
				mOnPreRefreshingAnimListener.onPreRefreshingAnim();
			}
	...
	public final void setOnPreRefreshingAnimListener(OnPreRefreshingAnimListener listener) {
		mOnPreRefreshingAnimListener = listener;
	}
	...
	private void addIndicatorViews() {
		...
		if (mode.showHeaderLoadingLayout() && null == mIndicatorIvTop) {
			...
			params.rightMargin = getResources().getDimensionPixelSize(R.dimen.dp10);
	 ...
	 *
	 */
	public interface OnPreRefreshingAnimListener{
		void onPreRefreshingAnim();
	}
}
