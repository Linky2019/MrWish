 ...
 */
package com.baselibrary.utils.downtime;

import android.os.CountDownTimer;

import com.baselibrary.utils.AbLogUtil;
        ...
        mCountDownTimer = new CountDownTimer(time, mills) {
            ...
            public void onTick(long millisUntilFinished) {
                if (listener != null) {
                    ...
                    //转为秒  tv_time.setText(millisUntilFinished/1000+"秒");
                } else {
                    AbLogUtil.e(TAG, "DownTimerListener 监听不能为空");
                }
            }
